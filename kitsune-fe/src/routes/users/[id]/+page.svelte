<script lang="ts">
    ...
    let account: { id: string; displayName: string; username: string; headerUrl: string; avatarUrl: string; } = $derived({
...
<main class="m-auto">
    ...
    {:else}
        <h1>
            ...
            <p class="text-center">
                Your ID is: <span class="card bg-base-100 shadow p-5">{account.id}</span>
