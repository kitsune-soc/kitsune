...
#[openapi(
    components(schemas(
        ...
        oauth::token::AccessTokenResponse,
        oauth::token::AuthorizationCodeData,
        oauth::token::ClientCredentialsData,
        oauth::token::PasswordData,
        oauth::token::RefreshTokenData,
        oauth::token::TokenForm,
        webfinger_type::Link,
