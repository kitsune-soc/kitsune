...
pub struct Activity {
    ...
    #[serde_with(as = "jsonld::serde::First<jsonld::serde::Id>")]
    pub actor: String,
...
pub struct Object {
    ...
    #[serde(default)]
    #[serde_with(as = "Option<jsonld::serde::First<jsonld::serde::Id>>")]
    ...
    pub published: Timestamp,
    #[serde(default)]
    #[serde_with(as = "OneOrMany<jsonld::serde::IdSet>")]
    pub to: Vec<String>,
    #[serde(default)]
    #[serde_with(as = "OneOrMany<jsonld::serde::IdSet>")]
    pub cc: Vec<String>,
